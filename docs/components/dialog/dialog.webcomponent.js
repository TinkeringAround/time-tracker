...
export class Dialog extends HTMLElement {
    ...
    onOpen(dateData) {
        ...
        this.startInputElement.value = start ? start : "08:00";
        this.startInputElement.blocked = disabled;
        this.pauseInputElement.value = pause ? pause : "00:40";
        this.pauseInputElement.blocked = disabled;
        this.endInputElement.value = end ? end : "15:40";
        this.endInputElement.blocked = disabled;
        this.workPlaceElement.value = workPlace ? workPlace : "Büro";
